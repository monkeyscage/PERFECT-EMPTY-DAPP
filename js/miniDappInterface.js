...
function connectToken(name,addr){


contracts[name] = {interface: 
[
	{
		"constant": true,
		"inputs": [],
...
contracts[name].contractClass = web3.eth.contract(contracts[name].interface);
contracts[name].contract = contracts[name].contractClass.at(contracts[name].address);
if (!ctrAddresses[name]){ ctrAddresses[name] = [] }ctrAddresses[name].push(addr);
